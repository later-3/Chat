...
只有少量C/C++基础时，先读[从Web小白到能设计开发Chat的学习路线](./项目掌握/00-从这里开始/从Web小白到能设计开发Chat的学习路线.md)，再读[从C++到Chat：前后端怎样跑起来](./项目掌握/00-从这里开始/从C++到Chat前后端怎样跑起来.md)和[Uvicorn、FastAPI与Chat后端基础](./项目掌握/00-从这里开始/Uvicorn-FastAPI与Chat后端基础.md)。这3篇先建立六级学习路线，再把进程、端口、HTTP/JSON/SSE和后端框架落到真实文件与可操作实验。
