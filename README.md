...
1. [项目协作规则](./AGENTS.md)
2. [0–15分钟接手](./docs/getting-started/quick-context.md)
3. [项目上下文](./PROJECT_CONTEXT.md)
4. [当前状态](./PROJECT_STATE.md)
5. [当前计划](./PROJECT_PLAN.md)
6. [技术与所有权合同](./docs/architecture/technology-contract.md)
7. [DSH前端与Chat后端交互](./docs/architecture/frontend-backend-interaction.md)
8. [Agent管理](./docs/architecture/agent-management-as-built.md)
9. [Prompt Studio与组装](./docs/architecture/prompt-studio-as-built.md)
10. [Session、轨迹与Trace](./docs/architecture/session-architecture.md)
11. [Workflow运行设计](./docs/architecture/runtime-workflows.md)
...
15. [状态与运行时边界](./docs/architecture/system-boundaries.md)
16. [产品设计准则](./docs/product/design-guidelines.md)
17. [工程规范](./docs/engineering-standards.md)
18. [本地安装指南](./docs/getting-started/local-install.md)
