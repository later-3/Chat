...
提交/推送不等于部署。部署前后健康、版本、渠道验收按[部署文档](../../operations/README.md)，不能为了调试重启正常服务。
...
本次版本的审核与验证结果见[2026-09-08调试手册验收记录](../../history/reviews/2026-09-08-debugging-handbook.md)。以后每次大幅调整仍在同目录追加日期化证据；小改动在提交中写明章节与验证。手册不是自动化监控任务，不会自行执行测试或登录渠道。
