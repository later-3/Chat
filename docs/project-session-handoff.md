...
2. `@chat/dsh-lifeos-bridge`是DSH与Chat公开Query/Command之间的唯一适配层，当前覆盖Plan审批与Note Candidate审核。
3. DSH Session仅是UI/运行缓存；Chat Product Store仍拥有Session、Message、Run、Plan、Approval、Note Candidate和Decision。
