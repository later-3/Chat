...
依据 [贡献流程](../../development/agent-contribution.md)、[模块合同](../../architecture/chat-module-contracts.md)、[Workflow](../../modules/workflows/chat-workflow-framework.md) 和各 Submodule 规则审核：
