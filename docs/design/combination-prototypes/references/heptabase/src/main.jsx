...
function applyReferenceContext() {
  ...
  document.documentElement.dataset.reference = "heptabase";
...
// The host keeps this iframe mounted. Theme updates therefore change only the
// document context and never rebuild the Whiteboard or discard Card edits.
