...
export const toolCatalog = [
  { id: "message", name: "Message Board", singular: "message", image: "/assets/basecamp-tools/message-board.webp", icon: "fa-message" },
  { id: "docs", name: "Docs & Files", singular: "document", image: "/assets/basecamp-tools/docs-files.webp", icon: "fa-folder-open" },
  { id: "todos", name: "Project Tasks", singular: "to-do", image: "/assets/basecamp-tools/to-dos.webp", icon: "fa-square-check" },
  { id: "chat", name: "Chat", singular: "message", image: "/assets/basecamp-tools/chat.webp", icon: "fa-comments" },
  { id: "schedule", name: "Schedule", singular: "event", image: "/assets/basecamp-tools/schedule.webp", icon: "fa-calendar-day" },
  { id: "cards", name: "Workflow", singular: "card", image: "/assets/basecamp-tools/card-table.webp", icon: "fa-table-columns" },
];
