...
export const insightsByPeriod = {
  7: [
    { day: "Mon", agent: 4, user: 2 },
    { day: "Tue", agent: 6, user: 3 },
    { day: "Wed", agent: 5, user: 4 },
    { day: "Thu", agent: 8, user: 2 },
    { day: "Fri", agent: 7, user: 5 },
    { day: "Sat", agent: 3, user: 1 },
    { day: "Sun", agent: 5, user: 3 },
  ],
  14: [
    { day: "Jul 27", agent: 18, user: 8 },
    { day: "Jul 30", agent: 14, user: 11 },
    { day: "Aug 2", agent: 21, user: 9 },
    { day: "Aug 5", agent: 17, user: 12 },
    { day: "Aug 8", agent: 23, user: 10 },
  ],
  30: [
    { day: "Jul 11", agent: 31, user: 13 },
    { day: "Jul 18", agent: 37, user: 18 },
    { day: "Jul 25", agent: 42, user: 20 },
    { day: "Aug 1", agent: 39, user: 23 },
    { day: "Aug 8", agent: 48, user: 19 },
  ],
};
...
export function transitionFeedItem(items, itemId, action, payload = {}) {
  ...
  if (!item) return { items, snapshot: null, notice: "Task not found" };

  const allowed = getActionSet(item);
  if (!allowed.includes(action)) return { items, snapshot: null, notice: "Action is not available for this task" };
...
export function restoreFeedItem(items, snapshot) {
