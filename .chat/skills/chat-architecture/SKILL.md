...
- Friend background work, long duties, schedules and group participation: `docs/development/long-agent-functionality-plan.md`; accepted target contracts are mechanism §9, Session §11 and the Workflow child-design LA0 section. LA0 probes demonstrate feasibility; LA1 adds explicit work bindings, per-Session workers and a released/reopened Workflow parent writer. Check the phase audit for actual acceptance evidence, not just this navigation entry.
