...
export function assertMapKeys(snapshot: ProductSnapshot, fail: Fail): void {
  const collections = [
    ...
    ["projectWorkBlock", snapshot.entities.projectWorkBlocks, "projectWorkBlockId"],
    ["projectWorkClaim", snapshot.entities.projectWorkClaims, "projectWorkClaimId"],
    ["projectWorkHandoff", snapshot.entities.projectWorkHandoffs, "projectWorkHandoffId"],
    [
      "projectPracticeRevision",
      snapshot.entities.projectPracticeRevisions,
    ...
    [
      ...
      snapshot.entities.projectProfileRevisions,
      "projectProfileRevisionId",
    ],
    [
    ...
    ["projectEvent", snapshot.entities.projectEvents, "projectEventId"],
    ["projectNeed", snapshot.entities.projectNeeds, "projectNeedId"],
    ["projectRequirement", snapshot.entities.projectRequirements, "projectRequirementId"],
    ["projectArtifactRef", snapshot.entities.projectArtifactRefs, "projectArtifactRefId"],
    [
      "projectMetricObservation",
      snapshot.entities.projectMetricObservations,
      "projectMetricObservationId",
    ],
    [
