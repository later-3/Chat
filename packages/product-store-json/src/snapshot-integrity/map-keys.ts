...
export function assertMapKeys(snapshot: ProductSnapshot, fail: Fail): void {
  const collections = [
    ...
    ["supervisedPlanningEpoch", snapshot.entities.supervisedPlanningEpochs, "planningEpochId"],
    ["supervisedCarryForward", snapshot.entities.supervisedCarryForwards, "carryForwardId"],
    ["supervisedStepState", snapshot.entities.supervisedStepStates, "supervisedStepStateId"],
    ["supervisedAgentAttempt", snapshot.entities.supervisedAgentAttempts, "attemptId"],
    ["supervisedStepEvidence", snapshot.entities.supervisedStepEvidence, "evidenceId"],
    ["supervisedStepCandidate", snapshot.entities.supervisedStepCandidates, "candidateId"],
    ["supervisedPlannerVerdict", snapshot.entities.supervisedPlannerVerdicts, "verdictId"],
    [
      "supervisedStepReviewRequest",
      snapshot.entities.supervisedStepReviewRequests,
      "reviewRequestId",
    ],
    ["supervisedStepHumanDecision", snapshot.entities.supervisedStepHumanDecisions, "decisionId"],
    [
      "supervisedAgentOutcomeObservation",
      snapshot.entities.supervisedAgentOutcomeObservations,
      "observationId",
    ],
    [
      "supervisedExecutionResult",
      snapshot.entities.supervisedExecutionResults,
      "supervisedExecutionResultId",
    ],
    [
