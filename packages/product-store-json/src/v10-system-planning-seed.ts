...
export const V10_SYSTEM_PLANNING_WORKFLOW_DEFINITION_ID = "wfd_systemplanningv1" as const;
export const V10_SYSTEM_PLANNING_WORKFLOW_REVISION_ID = "wfr_systemplanningv2" as const;
export const V10_SYSTEM_PLANNING_WORKFLOW_VIEW_ID = "wvd_systemplanningv2" as const;

/**
 * v9→v10必须永远生成旧context.memory revision 2，不能跟随当前系统Definition演进。
 */
export function createV10SystemPlanningSeed(createdAt: string): {
  ...
  const definition = workflowDefinitionSchema.parse({
    ...
    workflowDefinitionId: V10_SYSTEM_PLANNING_WORKFLOW_DEFINITION_ID,
    ownerKind: "system",
    key: "system.planning",
    title: "默认规划工作流",
    ...
    blueprintVersion: 1,
    status: "active",
    publishedRevisionId: V10_SYSTEM_PLANNING_WORKFLOW_REVISION_ID,
    revision: 2,
    createdAt,
    updatedAt: createdAt,
  });
  const revision = workflowDefinitionRevisionSchema.parse({
    ...
    workflowDefinitionRevisionId: V10_SYSTEM_PLANNING_WORKFLOW_REVISION_ID,
    workflowDefinitionId: V10_SYSTEM_PLANNING_WORKFLOW_DEFINITION_ID,
  ...
  const view = workflowViewDefinitionSchema.parse({
    ...
    workflowViewDefinitionId: V10_SYSTEM_PLANNING_WORKFLOW_VIEW_ID,
    ...content,
