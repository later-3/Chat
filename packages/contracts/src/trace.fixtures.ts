...
export const validTraceFixtures: ReadonlyArray<Record<string, unknown>> = [
  ...
  {
    ...base,
    eventName: TRACE_EVENT_NAMES.piToolStarted,
    outcome: "unknown",
    ...model,
    nodeKind: "planner",
    toolActivityId: "pit_0123456789abcdef01234567",
  ...
  },
  {
    ...
    ...model,
    nodeKind: "executor",
    toolActivityId: "pit_123456789abcdef012345678",
  ...
  },
  {
    ...
    ...model,
    nodeKind: "planner",
    toolActivityId: "pit_23456789abcdef0123456789",
    toolName: "submit_plan_candidate",
